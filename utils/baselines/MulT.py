...
from utils.baselines.submodels import TransformerEncoder
...
class MULTModel(nn.Module):
    def __init__(self):
        ...
        self.orig_d_l, self.orig_d_a, self.orig_d_v = 768, 74, 35  # MOSEI - 768, 74, 35 / MOSI - 768, 5, 20
        self.d_l, self.d_a, self.d_v = 40, 40, 40
        self.num_heads = 10  # MOSEI - 8 / MOSI - 10
        self.layers = 4
        self.attn_dropout = 0.2  # MOSEI - 0.1 / MOSI - 0.2
        self.attn_dropout_a = 0.0
        self.attn_dropout_v = 0.0
        self.relu_dropout = 0.1
        self.res_dropout = 0.1
        self.out_dropout = 0.1
        self.embed_dropout = 0.2  # MOSEI - 0.3 / MOSI - 0.2
        self.attn_mask = True
    ...
    def forward(self, x_l, x_a, x_v):
        ...
        x_l = self.text_model(x_l)  # BERT version
